...
parser.add_argument('--setting_name', type=str, default='CrossMamba_ETTh1_il168_ol24_sl6_win2_fa10_dm256_nh4_el3_itr0', help='name of the experiment')
...
args.t_cycle = hyper_parameters['t_cycle']; args.d_state = hyper_parameters['d_state']; args.d_model = hyper_parameters['d_model']; 
args.d_ff = hyper_parameters['d_ff']; args.dropout = hyper_parameters['dropout']; 
exp = Exp_crossmamba(args)
